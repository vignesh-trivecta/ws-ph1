...
import { setOpenModal } from '@/store/switchOrderSlice';
import React from 'react'
import { useSelector } from 'react-redux'

const SwitchOrder = () => {

  const openModal = useSelector((state) => state.switchOrder.openModal);

  return (
    <div className="container mx-auto px-8">
      <h1 className="font-bold">Switch Order</h1>
...
export const CustomTable = () => {
  const columnData = ['','Holdings', 'Balance Units', 'Purchase NAV', 'Current NAV', 'Purchase Value', 'Current Value', 'Gain', 'Holding Days', 'Master Scheme', 'Transaction Units', 'Transaction Amount', 'All Units', '']
  const rowData = [
    {
